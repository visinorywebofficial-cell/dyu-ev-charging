...
# We want to swap the colors. Currently section is bg-[#F1EFE1] and cards are bg-[#222222].
old_sec_1 = """      <section className="py-24 bg-[#F1EFE1]">
...
new_sec_1 = """      <section className="py-24 bg-[#222222]">
        <div className="container-wispr text-center">
...
old_sec_2 = """      <section className="py-24 bg-[#F1EFE1]">
...
new_sec_2 = """      <section className="py-24 bg-[#222222]">
        <div className="container-wispr">
          <div className="text-center mb-16">
            <h2 className="flex flex-col gap-1 mb-6 text-3xl md:text-4xl font-['Gilroy'] font-extrabold tracking-tighter leading-[1.1]" style={{ fontFamily: 'var(--font-figtree)' }}>
