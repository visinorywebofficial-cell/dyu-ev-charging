          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold uppercase tracking-widest text-sm text-[var(--color-smoke)] mb-1">Contact</h3>
                  <p className="font-medium text-lg leading-snug">
                    <a href="tel:+919949055516" className="hover:underline">+91 99490 55516</a>
                    <br />
                    <a href="mailto:sayhi@dyu.co.in" className="hover:underline">sayhi@dyu.co.in</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold uppercase tracking-widest text-sm text-[var(--color-smoke)] mb-1">Working Hours</h3>
                  <p className="font-medium text-lg leading-snug">
                    10am to 6pm
                  </p>
                </div>
